"""Synchronous PayChains API client."""
...
class PayChains:
    """Synchronous client for the PayChains API.

    Usage::

        from paychains import PayChains

        pc = PayChains("sk_live_...")
        payment = pc.payments.create(amount_usd=25.00, token="USDC", chain="solana")
    """
    ...
    class _Payments:
        ...
        def __init__(self, client: PayChains) -> None:
            self._client = client
    ...
    class _PaymentLinks:
        ...
        def create(
            ...
            **kwargs: Any,
            ...
            body.update(kwargs)
            return self._client._request("POST", "/payment-links", json=body)

        def get(self, link_id: str) -> dict[str, Any]:
            """Retrieve a payment link by ID."""
            return self._client._request("GET", f"/payment-links/{link_id}")

        def list(self) -> dict[str, Any]:
            """List all payment links."""
            return self._client._request("GET", "/payment-links")

        def delete(self, link_id: str) -> None:
            """Delete a payment link."""
            return self._client._request("DELETE", f"/payment-links/{link_id}")
    ...
    class _Subscriptions:
        ...
        def create(
            ...
            **kwargs: Any,
            ...
            if metadata is not None:
                body["metadata"] = metadata
            body.update(kwargs)
            return self._client._request("POST", "/subscriptions", json=body)
        ...
        def cancel(self, subscription_id: str) -> dict[str, Any]:
            ...
            return self._client._request("POST", f"/subscriptions/{subscription_id}/cancel")
    ...
    class _Payouts:
        ...
        def create(
            ...
            **kwargs: Any,
            ...
            body.update(kwargs)
            return self._client._request("POST", "/payouts", json=body)

        def get(self, payout_id: str) -> dict[str, Any]:
            """Retrieve a payout by ID."""
            return self._client._request("GET", f"/payouts/{payout_id}")
    ...
    class _Analytics:
        ...
        def summary(self, *, period: str = "30d") -> dict[str, Any]:
            ...
            return self._client._request("GET", "/analytics/summary", params={"period": period})

        def revenue(self, *, period: str = "30d", group_by: str = "day") -> dict[str, Any]:
